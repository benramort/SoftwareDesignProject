...
public class UserService {
	...
	public UserService() {
		...
		try {
			...
			User newUser = new User("benat@benat.es", "Benat", "Ramirez", date);
	...
	public void createUser(String email, String password, String name, String surname, Date birthdate, float weight, float height,
		...
		User newUser = new User(email, name, surname, birthdate);
		if (weight >= 0) {
